    ...
    return(
        <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 p-6 flex justify-between items-center border-b border-gray-200 dark:border-gray-700 shadow-sm">
            ...
            <div className="flex items-center gap-6">
                ...
                <button className="relative p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full transition duration-200">
                    <IoNotificationsOutline size={24} className="text-gray-600 dark:text-gray-300"/>
                ...
                <div className="relative">
                    ...
                    <div id="userDropdown" className="hidden absolute right-0 mt-3 w-56 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden z-50">
                        <div className="py-2">
                            <Link to="/admin/userprofile" className="flex px-6 py-3 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 transition duration-200">
                                User Profile
                            </Link>
                            <hr className="border-gray-100 dark:border-gray-700"/>
                            <Link to="/logout" className="flex px-6 py-3 text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 transition duration-200">
                                Logout
                            </Link>
                        </div>
                    </div>
