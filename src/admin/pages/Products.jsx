        ...
        <div className="p-4 dark:bg-gray-900">
            ...
            <dialog id="addProductModal" className="p-8 rounded-xl shadow-2xl backdrop-blur-sm bg-white dark:bg-gray-800">
                <div className="flex flex-col gap-6">
                    ...
                    <input type="text" placeholder="Product Description" className="border-2 border-gray-200 dark:border-gray-700 dark:bg-gray-900 dark:text-white p-3 rounded-lg focus:border-black dark:focus:border-white focus:outline-none transition duration-200 hover:border-gray-300 dark:hover:border-gray-600"/>
                                ...
                                <dialog id="categoryModal" className="p-8 rounded-xl shadow-2xl backdrop-blur-sm bg-white dark:bg-gray-800"  >
                                    <div className="flex flex-col gap-6">
                                        ...
                                        <div className="flex gap-4" >
                                                ...
                                                <input type="text" name="category" placeholder="New Category Name" className="flex-1 border-2 border-gray-200 dark:border-gray-700 dark:bg-gray-900 dark:text-white p-3 rounded-lg focus:border-black dark:focus:border-white focus:outline-none transition duration-200 hover:border-gray-300 dark:hover:border-gray-600"/>
                                                <input type="text" name="description" placeholder="Description" className="flex-1 border-2 border-gray-200 dark:border-gray-700 dark:bg-gray-900 dark:text-white p-3 rounded-lg focus:border-black dark:focus:border-white focus:outline-none transition duration-200 hover:border-gray-300 dark:hover:border-gray-600"/>
                ...
                <table className="w-full border-collapse border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                    ...
                    <tbody>
                        <tr className="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 dark:text-white">
                            ...
                            <td className="p-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quos.</td>
