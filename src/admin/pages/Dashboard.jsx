    ...
    return(
       ...
       <div className="p-4 dark:bg-gray-900 font-mono">
        <div className="grid grid-cols-4 gap-6">
           <div className="text-2xl font-bold text-white p-6 rounded-xl shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer bg-gradient-to-r from-blue-500 to-purple-600">
